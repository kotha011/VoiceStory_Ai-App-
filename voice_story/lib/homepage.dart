...
import 'menubar.dart';
// import 'profile_page.dart'; // Uncomment this once you create the file!
...
class HomePageState extends State<HomePage> {
  // Removed unused AudioPlayer, ApiService, and _playAiVoice() to clear warnings!
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          borderRadius: BorderRadius.circular(30),
                          onTap: () {
                            // TEMPORARY FIX: Show a snackbar instead of crashing since ProfilePage doesn't exist yet
                            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Profile Page coming soon!")));

                            // Uncomment this line when ProfilePage is ready:
